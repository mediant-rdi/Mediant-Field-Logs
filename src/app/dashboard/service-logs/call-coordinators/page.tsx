// src/app/dashboard/service-logs/call-coordinators/page.tsx
'use client';
    ...
    return (
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            <ul role="list" className="divide-y divide-gray-200">
                {periods.map((period) => (
                    <li key={period._id}>
                        <Link href={`/dashboard/service-logs/call-coordinators/${period._id}`} className="block hover:bg-gray-50 transition-colors">
